<div id="sidebar" class="c-sidebar c-sidebar-fixed c-sidebar-lg-show">
    ...
    <ul class="c-sidebar-nav">
        ...
        @endcan
        @can('corrective_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.correctives.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/correctives") || request()->is("admin/correctives/*") ? "c-active" : "" }}">
        ...
        @endcan
        @can('setting_corrective_access')
            <li class="c-sidebar-nav-dropdown {{ request()->is("admin/sources*") ? "c-show" : "" }} {{ request()->is("admin/statuses*") ? "c-show" : "" }}">
                <a class="c-sidebar-nav-dropdown-toggle" href="#">
                    <i class="fa-fw fas fa-cogs c-sidebar-nav-icon">

                    </i>
                    {{ trans('cruds.settingCorrective.title') }}
                </a>
                <ul class="c-sidebar-nav-dropdown-items">
                    @can('source_access')
                        <li class="c-sidebar-nav-item">
